...
{
    /// <summary>
    /// Interaction logic for RotateTransformation.xaml
    /// </summary>
    public partial class RotateTransformation : Window
    {
        ...
        private void SetMatrixCamera()
        {
            ...
            myCameraMatrix.ViewMatrix =
            Utility.SetViewMatrix(cameraPosition,
            ...
            {
                myCameraMatrix.ProjectionMatrix =
                Utility.SetPerspectiveFov(
                fov, aspectRatio, zn, zf);
            }
        }
